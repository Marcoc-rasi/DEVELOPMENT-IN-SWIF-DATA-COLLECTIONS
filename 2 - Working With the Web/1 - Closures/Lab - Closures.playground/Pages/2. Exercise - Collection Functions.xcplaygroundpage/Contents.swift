 ...
 */
func forwads(name1: String, name2: String) -> Bool {
    print(name1)
    print(name2)
    return name1 < name2
}
...
let friendsNames: [String] = ["caro","marcos","darve","shariel"]
let sortedCollection1 = friendsNames.sorted(by: forwads)
...
let sortedCollection2 = friendsNames.sorted(by: { (name1, name2) -> Bool in
    return name1 < name2
})
...
//let sortedCollection3 = friendsNames.sorted { $0 < $1 }
let sortedCollection3 = friendsNames.sorted(by: <)
